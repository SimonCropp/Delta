...
### When **no** `VIEW SERVER STATE` permission exists and change tracking is enabled
...
snippet: SqlServerTimeStampWithChangeTracking


### When **no** `VIEW SERVER STATE` permission exists and change tracking is **not** enabled
